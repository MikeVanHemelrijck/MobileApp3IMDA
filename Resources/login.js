...
{  
    ...
    {         
       loginReq.open('GET','http://www.vanhouckebram2011.dreamhosters.com/mobiele/login.php?username='+txtUsername.value+'&password='+Ti.Utils.md5HexDigest(txtPassword.value)); 
       loginReq.send();
    }  
    else  
    {  
